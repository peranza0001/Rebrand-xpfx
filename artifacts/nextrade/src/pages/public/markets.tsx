  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-10">
      <div className="mb-8 max-w-2xl">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-white">Live markets</h1>
        ...
        <table className="w-full text-sm min-w-[640px]">
          ...
          <tbody>
            {filtered.map((t) => {
              ...
              return (
                <tr key={t.symbol} className="border-b border-white/10 last:border-0 hover:bg-emerald-500/5">
                  ...
                  <td className={`px-4 py-3 text-right font-mono ${up ? "text-emerald-300" : "text-rose-300"}`}>
            ...
            {filtered.length === 0 && (
              <tr><td colSpan={7} className="px-4 py-8 text-center text-slate-400">No instruments match your search.</td></tr>
            )}
          </tbody>
        </table>
      </CardContent>
