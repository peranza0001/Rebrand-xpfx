...
<!-- AUTO-UPDATE:START -->
## 🤖 AUTO-SYNC MEMORY
- Last sync: 2026-08-25 11:53:46 UTC
- Memory rule: Any AI change must refresh this file before finishing the task.
- This project now auto-syncs the memory log via the `remember:update` script and git hooks.
- Current working tree: M  artifacts/api-server/src/lib/simulation-engine.ts | M  artifacts/api-server/src/routes/demo-trading.ts | M  tests/api-routes.test.mjs
<!-- AUTO-UPDATE:END -->
