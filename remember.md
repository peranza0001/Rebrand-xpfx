...
<!-- AUTO-UPDATE:START -->
## 🤖 AUTO-SYNC MEMORY
- Last sync: 2026-08-27 08:38:28 UTC
- Memory rule: Any AI change must refresh this file before finishing the task.
- This project now auto-syncs the memory log via the `remember:update` script and git hooks.
- Current working tree: M  artifacts/api-server/src/routes/demo-trading.ts | M  artifacts/nextrade/src/pages/demo-trading.tsx
<!-- AUTO-UPDATE:END -->
