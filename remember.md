...
<!-- AUTO-UPDATE:START -->
## 🤖 AUTO-SYNC MEMORY
- Last sync: 2026-08-28 04:34:45 UTC
- Memory rule: Any AI change must refresh this file before finishing the task.
- This project now auto-syncs the memory log via the `remember:update` script and git hooks.
- Current working tree: M  artifacts/api-server/package.json | M  artifacts/api-server/src/lib/session.ts | M  artifacts/api-server/src/routes/wallets.ts
<!-- AUTO-UPDATE:END -->
